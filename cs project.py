...
def display_question():
    ...
    question_label = tk.Label(window, text=questions[current_question],font=("Arial", 20, "italic",'underline'),bg='yellow') #grey was default
    ...
    for choice in choices[current_question]:
        button = tk.Button(
            window,
            text=choice,
            fg='blue', #change colour of font
            font=("Times New Roman", 20, "bold"), #style of font
...
# Fix lambda reference issue (attach button explicitly)
    ...
    next_button = tk.Button(window, text="Next", font=("Arial", 20, "bold"),command=next_question)
...
window.configure(bg="pink") #window background colour
